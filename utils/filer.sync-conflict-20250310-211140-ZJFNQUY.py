...
class Filer:
    ...
    def filepath_formatter(
        ...
        """
        try:
            if extension and filepath.suffix == extension:
                return filepath
            else:
                return f"{filepath}.{extension}" if extension else filepath
        except Exception as e:
    ...
    def filename_formatter(
        ...
        """
        try:
            stripped_filename = Path(filename).name
            if extension and stripped_filename.suffix == extension:
                return stripped_filename
            else:
                return (
                    f"{stripped_filename}.{extension}"
                    if extension
                    else stripped_filename
                )
        except Exception as e:
